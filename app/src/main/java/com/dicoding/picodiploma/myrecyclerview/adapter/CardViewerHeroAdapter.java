...
public class CardViewerHeroAdapter extends RecyclerView.Adapter<CardViewerHeroAdapter.CardViewViewHolder> {
    private ArrayList<Hero> listHero;

    public CardViewerHeroAdapter(ArrayList<Hero> list) {
        this.listHero = list;
    }

    @NonNull
    @Override
    public CardViewerHeroAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
